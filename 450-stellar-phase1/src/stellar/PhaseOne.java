...
public class PhaseOne {
	...
	private static void transfer(String destinationAccount) throws IOException {
		//double amount = Character.getNumericValue(hashStr.charAt(0)) + Character.getNumericValue(hashStr.charAt(0)) * 10
		...
		Transaction transaction = new Transaction.Builder(sourceAccount)
				.addOperation(
						new PaymentOperation.Builder(destination, new AssetTypeNative(), "10").build())
